...
--
-- Host: localhost    Database: sncf_reservation
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`yuexuan`@`localhost`*/ /*!50003 TRIGGER `get_price` AFTER INSERT ON `halls` FOR EACH ROW begin
...
-- Dump completed on 2021-12-05 21:43:41
